...
public final class Login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                <img src=\"../imagenes/logoestancoo.jpg\" alt=\"\" class=\"shoe-image\"/>\r\n");
      ...
      out.write("        <script>\r\n");
      out.write("            // Funciones para mostrar y ocultar formularios\r\n");
      out.write("            function showLogin() {\r\n");
      out.write("                document.getElementById('login-form').classList.add('active');\r\n");
      out.write("                document.getElementById('signup-form').classList.remove('active');\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
      out.write("            function showSignUp() {\r\n");
      out.write("                document.getElementById('signup-form').classList.add('active');\r\n");
      out.write("                document.getElementById('login-form').classList.remove('active');\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
      out.write("            // Validación de contraseñas en el formulario de registro\r\n");
      out.write("            document.getElementById('signup-form').addEventListener('submit', function (event) {\r\n");
      out.write("                const password = document.getElementById('contrasena').value;\r\n");
      out.write("                const repeatPassword = document.getElementById('contrasena_repetir').value;\r\n");
      out.write("\r\n");
      out.write("                if (password !== repeatPassword) {\r\n");
      out.write("                    event.preventDefault();\r\n");
      out.write("                    document.getElementById('formulario_mensaje').innerHTML = '<p><i class=\"bi bi-exclamation-triangle\"></i><b> Error:</b> Las contraseñas no coinciden.</p>';\r\n");
      out.write("                }\r\n");
      out.write("            });\r\n");
      out.write("        </script>\r\n");
      out.write("        <script>\r\n");
      out.write("        document.getElementById('formulario').addEventListener('submit', function (event) {\r\n");
      out.write("\r\n");
      out.write("            const fechaNacimiento = new Date(document.getElementById('fechanaci').value);\r\n");
      out.write("\r\n");
      out.write("            const fechaActual = new Date();\r\n");
      out.write("\r\n");
      out.write("            const edad = fechaActual.getFullYear() - fechaNacimiento.getFullYear();\r\n");
      out.write("\r\n");
      out.write("            const mes = fechaActual.getMonth() - fechaNacimiento.getMonth();\r\n");
      out.write("            if (mes < 0 || (mes === 0 && fechaActual.getDate() < fechaNacimiento.getDate())) {\r\n");
      out.write("                edad--;\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
      out.write("            if (edad < 18) {\r\n");
      out.write("                event.preventDefault();\r\n");
      out.write("                alert('Debes tener al menos 18 años para registrarte.');\r\n");
      out.write("            }\r\n");
      out.write("        });\r\n");
      out.write("    </script>\r\n");
      out.write("    </body>\r\n");
